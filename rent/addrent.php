...
<section class="content-header">
  <h1><?php echo "Add new Tenant";?></h1>
  <ol class="breadcrumb">
    <li><a href="<?php echo WEB_URL?>dashboard.php"><i class="fa fa-dashboard"></i><?php echo $_data['home_breadcam'];?></a></li>
    <li class="active"><?php echo "Tenant Information";?></li>
    <li class="active"><?php echo "Add Tenant";?></li>
  </ol>
</section>
<!-- Main content -->
