    ...
    <div class="box box-info">
      ...
      <form onSubmit="return validateMe();" action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input type="text" name="txtBName" value="" id="txtBName" class="form-control" />
        </div>
        <div class="form-group">
          <label for="txtBAddress"><span style="color:red;">*</span>Address :</label>
          <textarea name="txtBAddress" id="txtBAddress" class="form-control"></textarea>
        </div>
        <div class="form-group">
          <label for="txtBSecurityGuardMobile"><span style="color:red;">*</span>Security Guard Mobile:</label>
          <input type="text" name="txtBSecurityGuardMobile" value="" id="txtBSecurityGuardMobile" class="form-control" />
        </div>
        <div class="form-group">
          <label for="txtBSecrataryMobile"><span style="color:red;">*</span>Secretary Mobile :</label>
          <input type="text" name="txtBSecrataryMobile" value="" id="txtBSecrataryMobile" class="form-control" />
        </div>
        <div class="form-group">
          <label for="txtBModeratorMobile"><span style="color:red;">*</span>Moderator Mobile :</label>
          <input type="text" name="txtBModeratorMobile" value="" id="txtBModeratorMobile" class="form-control" />
        </div>
        <div class="form-group">
        ...
        <div class="box-body">
          <div class="form-group">
            ...
            <input type="text" name="txtBlName" value="" id="txtBlName" class="form-control" />
          </div>
          <div class="form-group">
            <label for="txtBlAddress"><span style="color:red;">*</span>Address :</label>
            <textarea name="txtBlAddress" id="txtBlAddress" class="form-control"></textarea>
          </div>
          <div class="form-group">
            <label for="txtBlPhone"><span style="color:red;">*</span>Phone :</label>
            <input type="text" name="txtBlPhone" value="" id="txtBlPhone" class="form-control" />
          </div>
          <div class="form-group">
