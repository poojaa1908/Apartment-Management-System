...
<header class="main-header">
  ...
  <span class="logo-mini">APARTMENT MANAGEMENT SYSTEM</span>
...
<aside class="main-sidebar">
  ...
  <section class="sidebar" style="margin-top:10px;">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="treeview <?php if($page_name != '' && $page_name == 'addrent' || $page_name == 'rentlist'){echo 'active';}?>"> <a href="#"> <i class="fa fa-users"></i> <span><?php echo "Tenant Information"; ?></span> <i class="fa fa-angle-left pull-right"></i> </a>
        <ul class="treeview-menu">
          <li class="<?php if($page_name != '' && $page_name == 'rentlist'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>rent/rentlist.php"><i class="fa fa-arrow-circle-right"></i><?php echo "Tenant List"; ?></a></li>
		  <li class="<?php if($page_name != '' && $page_name == 'addrent'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>rent/addrent.php"><i class="fa fa-arrow-circle-right"></i><?php echo "Add Tenant"; ?></a></li>
        </ul>
      </li>
...
<form id="updateprofile" action="<?php echo WEB_URL; ?>ajax/updateProfile.php" method="post">
  ...
  <?php } else { ?>
  <input type="hidden" name="user_id" value="<?php echo $_SESSION['objLogin']['name']; ?>" >
  <?php } ?>
</form>
