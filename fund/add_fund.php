        ...
        <div class="box-body">
          <div class="form-group">
            ...
            <select name="ddlOwnerName" id="ddlOwnerName" class="form-control">
              ...
              <?php 
				  	$result_owner = mysqli_query($conn,"SELECT * FROM tbl_add_owner order by ownid ASC",$link);
          ...
          <div class="form-group">
            ...
            <select name="ddlMonth" id="ddlMonth" class="form-control">
              ...
              <?php 
				  	$result_month = mysqli_query($conn,"SELECT * FROM tbl_add_month_setup order by m_id ASC",$link);
          ...
          <div class="form-group">
            ...
            <select name="ddlYear" id="ddlYear" class="form-control">
              ...
              <?php 
				  	$result_month = mysqli_query($conn,"SELECT * FROM tbl_add_year_setup order by y_id ASC",$link);
					while($row_month = mysqli_fetch_array($result_month)){?>
