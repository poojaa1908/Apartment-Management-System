...
if(isset($_GET['id']) && $_GET['id'] != ''){
	$result = mysqli_query($conn,"SELECT * FROM tbl_add_owner where ownid = '" . $_GET['id'] . "'");
	...
	$result_unit = mysqli_query($conn,"SELECT unit_id FROM tbl_add_owner_unit_relation where owner_id = '" . $_GET['id'] . "'");
