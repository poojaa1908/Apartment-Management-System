...
<!-- Site wrapper -->
<div class="wrapper">
<span class="main-header"><a href="dashboard.php" class="logo"><span class="logo-mini">Apartment Management System</span>
<!-- logo for regular state and mobile devices -->
<span class="logo-lg"><b></b> Apartment Management System</span> </a>
    ...
    <ul class="sidebar-menu">
      ...
      <li class="treeview <?php if($page_name != '' && $page_name == 'addcomplain' || $page_name == 'complainlist'){echo 'active';}?>"> <a href="#"> <i class="fa fa-warning"></i> <span><?php echo $_data['menu_complain'];?></span> <i class="fa fa-angle-left pull-right"></i> </a>
        <ul class="treeview-menu">
          <li class="<?php if($page_name != '' && $page_name == 'complaintlist'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>t_dashboard/tcomplainlist.php"><i class="fa fa-arrow-circle-right"></i><?php echo $_data['menu_complain_list'];?></a></li>
		  <li class="<?php if($page_name != '' && $page_name == 'addtcomplain'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>t_dashboard/addtcomplain.php"><i class="fa fa-arrow-circle-right"></i><?php echo $_data['menu_add_complain'];?></a></li>
        </ul>
      </li>
        ...
        <li class="<?php if($page_name != '' && $page_name == 'index'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>t_dashboard/index.php"><i class="fa fa-bar-chart-o"></i><span><?php echo "Bulletin Board"?></span></a></li>
        <li class="<?php if($page_name != '' && $page_name == 'unit_details'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>t_dashboard/unit_details.php"><i class="fa fa-empire"></i><span><?php echo 'Profile';?></span></a></li>
      </li>
    </ul>
  </section>
  <!-- /.sidebar -->
