    ...
    <div class="box box-info">
     ...
     <form onSubmit="return validateMe();" action="<?php echo WEB_URL; ?>fair/addfair.php" method="post" enctype="multipart/form-data">
        <div class="box-body">
          ...
          <div class="form-group">
            <label for="txtRent">Tenant Name :</label>
