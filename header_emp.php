...
$employee_id=$_SESSION['objLogin']['e_designation'];
function curPageURL() {
 $pageURL = 'http';
...
$desig = '';
$resultx = mysqli_query($conn, "SELECT * FROM tbl_add_member_type where member_id ='$employee_id'");
...
<header class="main-header"><nav class="navbar navbar-static-top" role="navigation">
  ...
  <section class="sidebar" style="margin-top:10px;">
    ...
    <ul class="sidebar-menu">
      <li class="<?php if($page_name != '' && $page_name == 'e_dashboard'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>e_dashboard.php"><i class="fa fa-dashboard"></i> <span><?php echo $_data['menu_dashboard'];?></span></a> </li>
       ...
       <li class="<?php if($page_name != '' && $page_name == 'rented_details'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>e_dashboard/rented_details.php"><i class="fa fa fa-user"></i><span><?php echo "Tenant Details";?></span></a></li>
       ...
       <li class="<?php if($page_name != '' && $page_name == 'e_report'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>e_dashboard/ecomplainlist.php"><i class="fa fa fa fa-bar-chart-o"></i><span><?php echo "Complain List";?></span></a></li>
    </ul>
  </section>
  <!-- /.sidebar -->
</aside>
