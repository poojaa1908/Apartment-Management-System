...
<div class="row">
  <div class="col-xs-12">
    ...
    <div id="you" class="alert alert-success alert-dismissable" style="display:<?php echo $addinfo; ?>">
      ...
      <?php echo $msg; ?> </div>
    <div align="right" style="margin-bottom:1%;"> <a class="btn btn-primary" data-toggle="tooltip" href="<?php echo WEB_URL; ?>t_dashboard/addtcomplain.php" data-original-title="<?php echo $_data['text_3'];?>"><i class="fa fa-plus"></i></a> <a class="btn btn-primary" data-toggle="tooltip" href="<?php echo WEB_URL; ?>t_dashboard.php" data-original-title="<?php echo $_data['home_breadcam'];?>"><i class="fa fa-dashboard"></i></a> </div>
...
function deleteComplain(Id){
	...
	if(iAnswer){
		window.location = '<?php echo WEB_URL; ?>t_dashboard/tcomplainlist.php?id=' + Id;
	}
  }
