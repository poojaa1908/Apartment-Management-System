      ...
      <div class="box-body">
        <table class="table sakotable table-bordered table-striped dt-responsive">
          ...
          <tbody>
            ...
            <td><?php echo CURRENCY.$_SESSION['objLogin']['r_rent_pm'].' '; ?></td>
            <td><?php echo CURRENCY.$row['total_rent'].' '; ?></td>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
				  ...
				  <div class="modal-body">
                    <h3 style="text-decoration:underline;"><?php echo "DETAILS";?></h3>
                    <div class="row">
                      <div class="col-xs-6"> 
                        ...
                        <b><?php echo $_data['text_11'];?> :</b> <?php echo CURRENCY.$row['rent'].' '; ?><br/>
                        </div>
                        <div class="col-xs-6"> 
                        <b><?php echo $_data['text_12'];?> :</b> <?php echo CURRENCY. $row['water_bill'].' '; ?><br/>
                        <b><?php echo $_data['text_13'];?> :</b> <?php echo CURRENCY. $row['electric_bill'].' '; ?><br/>
                        <b><?php echo $_data['text_14'];?> :</b> <?php echo CURRENCY. $row['gas_bill'].' '; ?><br/>
                        <b><?php echo $_data['text_15'];?> :</b> <?php echo CURRENCY. $row['security_bill'].' '; ?><br/>
                        <b><?php echo $_data['text_16'];?> :</b> <?php echo CURRENCY. $row['utility_bill'].' '; ?><br/>
                        <b><?php echo $_data['text_17'];?> :</b> <?php echo CURRENCY. $row['other_bill'].' '; ?><br/>
                        <b><?php echo "Total Rent";?> :</b> <?php echo CURRENCY. $row['total_rent']; ?><br/>
